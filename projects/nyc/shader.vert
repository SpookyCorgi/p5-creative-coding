//this is basically the local position of the shape
...
void main()
{
  //there is currently no modelmatrix in p5js which is stupid, so we have to invert it ourselves
  //https://github.com/processing/p5.js/issues/5287
  //https://stackoverflow.com/questions/1147280/glsl-extracting-modelmatrix-from-modelviewmatrix-and-viewmatrix this is also wrong, the formula needs to be reversed
  mat4 modelMatrix = inverse(uViewMatrix)*uModelViewMatrix;
